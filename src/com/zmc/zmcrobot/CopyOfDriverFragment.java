 ...
 *
 */
public class CopyOfDriverFragment extends Fragment implements Runnable , SensorEventListener{
...
//		mSteerView = (SteerView) rootView.findViewById(R.id.bSteerView);
		...
		mJoystickView = (JoystickView)	rootView.findViewById(R.id.joystickView);
		...
		mHomeButton = (Button)rootView.findViewById(R.id.homeButton);
		...
		mTextViewVW = (TextView) rootView.findViewById(R.id.textViewVW);
		...
		mGravityCheckBox = (CheckBox)rootView.findViewById(R.id.GravityCheckBox);
		...
		mBrakeButton = (ImageButton) rootView.findViewById(R.id.brakeButton);
		...
		mIBSpeed = (ImageButton) rootView.findViewById(R.id.speederButton);
		...
		mIBSpeedR = (ImageButton) rootView.findViewById(R.id.speeder_rButton);
