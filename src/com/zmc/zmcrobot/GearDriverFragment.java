 ...
 *
 */
public class GearDriverFragment extends Fragment implements Runnable , SensorEventListener{
...
//    private final float[] mRotationMatrix = new float[16];
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mView = inflater.inflate(R.layout.fragment_driver,
				container, false);
...
//		mJoystickView = (JoystickView)	rootView.findViewById(R.id.joystickView);
	...
	public void updateBLEState(boolean bConnected) {
		...
		mBrakeButton.setEnabled( mConnected );
		mIBSpeedR.setEnabled(mConnected);
		mIBSpeed.setEnabled(mConnected);
		mHomeButton.setEnabled(mConnected);
		mSimulateCheckBox.setEnabled(mConnected);
	}
